...
В проекте два скрипта. script.js -- короткий и удобный, но не подходит для массивов с большим числом элементов (убран в комменты). Наиболее универсальный вариант -- в файле script_2.js.
